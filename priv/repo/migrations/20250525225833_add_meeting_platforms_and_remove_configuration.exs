defmodule SocialContentGenerator.Repo.Migrations.AddMeetingPlatformsAndRemoveConfiguration do
  ...
  def up do
    ...
    VALUES
      ('Zoom', 'zoom', 'zoom', 'Zoom video conferencing platform', 'https://img.freepik.com/premium-photo/square-zoom-logo-isolated-white-background_469489-1056.jpg?semt=ais_hybrid&w=740', '{"meeting"}', NOW(), NOW()),
